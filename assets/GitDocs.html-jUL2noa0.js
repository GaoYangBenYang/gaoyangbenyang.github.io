import{_ as e}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as i,c as n,a as d}from"./app-OC-itDNz.js";const a={},s=d(`<h2 id="_1-git简介" tabindex="-1"><a class="header-anchor" href="#_1-git简介" aria-hidden="true">#</a> 1.Git简介</h2><h2 id="_2-git结构及基础命令" tabindex="-1"><a class="header-anchor" href="#_2-git结构及基础命令" aria-hidden="true">#</a> 2.Git结构及基础命令</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>工作区（写代码）
== git add ==&gt; 暂存区（临时存储）
== git commit ==&gt; 本地区（历史版本） 
