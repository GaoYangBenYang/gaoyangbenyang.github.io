import{_ as n}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as s,c as i,e as a}from"./app-NmK27k8m.js";const e={},l=a(`<h2 id="使用yaml-v2进行配置文件读取-只能读取yml" tabindex="-1"><a class="header-anchor" href="#使用yaml-v2进行配置文件读取-只能读取yml" aria-hidden="true">#</a> 使用yaml.v2进行配置文件读取(只能读取yml)</h2><h3 id="yaml配置文件" tabindex="-1"><a class="header-anchor" href="#yaml配置文件" aria-hidden="true">#</a> yaml配置文件</h3><div class="language-yaml line-numbers-mode" data-ext="yml"><pre class="language-yaml"><code><span class="token key atrule">Application</span><span class="token punctuation">:</span>
