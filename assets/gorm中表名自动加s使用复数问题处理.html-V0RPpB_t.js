import{_ as e}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as n,c as a,e as t}from"./app-nytzDS8Q.js";const o={},i=t(`<h2 id="在gorm配置文件中添加单数表名配置项" tabindex="-1"><a class="header-anchor" href="#在gorm配置文件中添加单数表名配置项" aria-hidden="true">#</a> 在gorm配置文件中添加单数表名配置项</h2><div class="language-golang line-numbers-mode" data-ext="golang"><pre class="language-golang"><code>	db, err := gorm.Open(mysql.New(mysql.Config{
